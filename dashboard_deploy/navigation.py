...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            ...
            st.page_link("pages/01margems.py", label="01Magens")
            st.page_link("pages/02margens.py", label="02Magens")
            st.page_link("pages/modo_vendas.py", label="modo_vendas")
            ...
            st.page_link("pages/custo-frota.py")
