...
PAGES = [
    ...
    {"file": "centro_custo.py", "label": "Centro de custo", "permitir": ACCESS_CONTROL.get("centro_custo.py")},
    ...
    {"file": "modo_venda_itens_curva.py", "label": "Vendas intens e curva", "permitir": ACCESS_CONTROL.get("modo_venda_itens_curva.py")},
    {"file": "modo_vendas_sem_curva.py", "label": "Vendas sem curva", "permitir": ACCESS_CONTROL.get("modo_vendas_sem_curva.py")},
    {"file": "entrega_em_40.py", "label": "Indicadores de Entregas", "permitir": ACCESS_CONTROL.get("entrega_em_40.py")},
    {"file": "entrega_e_rota.py", "label": "Entrega e rota", "permitir": ACCESS_CONTROL.get("entrega_e_rota.py")},
